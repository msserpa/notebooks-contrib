...
if (( $RAPIDS_RESULT >= 11 )) ;then
  ...
  echo " "
  echo "SCRIPT TO COPY: "
  echo "!wget -nc https://raw.githubusercontent.com/rapidsai-community/notebooks-contrib/branch-0.14/utils/rapids-colab.sh"
...
wget -nc https://raw.githubusercontent.com/rapidsai-community/notebooks-contrib/branch-0.14/utils/env-check.py
...
if [ ! -f Miniconda3-4.5.4-Linux-x86_64.sh ]; then
    ...
    # install RAPIDS packages
        ...
        wget -nc https://raw.githubusercontent.com/rapidsai-community/notebooks-contrib/branch-0.14/utils/update_pyarrow.py
